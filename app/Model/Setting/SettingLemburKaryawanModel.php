...
class SettingLemburKaryawanModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'st_lembur_karyawan';
    protected $primaryKey = 'stlemburkaryawan_id';
    public $timestamps = false;

    protected static $logName = 'lembur_karyawan';
    protected static $logUnguarded = true;
    protected $labelTableName = 'st_lembur_karyawan';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan pengaturan Lembur baru";
        } else {
            return "$defaultCauserName melakukan perubahan data pengaturan Lembur";
        }
