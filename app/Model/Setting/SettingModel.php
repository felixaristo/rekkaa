...
class SettingModel extends Model
{
    ...
    protected $labelTableName = 'st_setting';
     ...
     */
    protected $fillable = [
        'setting_key', 'setting_value', 'setting_description', 'setting_aktif',
    ];
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan setting/pengaturan baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data setting/pengaturan dengan ID ";
        }
