...
class SettingTunjanganKaryawanDetailModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'st_tunjangan_karyawan_detail';
    protected $primaryKey = 'sttunjangankaryawandet_id';
    public $timestamps = false;
    
    protected static $logName = 'tunjangan_karyawan_detail';
    protected static $logUnguarded = true;
    protected $labelTableName = 'st_tunjangan_karyawan_detail';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan pengaturan detail tunjangan baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data pengaturan detail tunjangan dengan ID ";
        }

        // return "[$defaultCauserType] $defaultCauserName, {$eventName} by: " . $defaultCauserName;
    }

    function sttunjangan() {
        return $this->belongsTo('App\Model\Setting\SettingTunjanganKaryawanModel', 'st_tunjangankaryawan_id', 'sttunjangankaryawan_id');
    }
