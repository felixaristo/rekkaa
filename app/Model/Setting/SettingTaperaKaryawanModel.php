...
class SettingTaperaKaryawanModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'st_tapera_karyawan';
    protected $primaryKey = 'sttaperakaryawan_id';
    public $timestamps = false;

    protected static $logName = 'tapera_karyawan';
    protected static $logUnguarded = true;
    protected $labelTableName = 'st_tapera_karyawan';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan pengaturan Tapera baru";
        } else {
            return "$defaultCauserName melakukan perubahan data pengaturan Tapera";
        }
