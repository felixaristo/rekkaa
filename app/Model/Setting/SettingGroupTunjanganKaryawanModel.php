...
class SettingGroupTunjanganKaryawanModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'st_group_tunjangan_karyawan';
    protected $primaryKey = 'stgrouptunjangankaryawan_id';
    public $timestamps = false;

    protected static $logName = 'group_tunjangan_karyawan';
    protected static $logUnguarded = true;
    protected $labelTableName = 'st_group_tunjangan_karyawan';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan group tunjangan karyawan baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data group tunjangan karyawan dengan ID ";
        }
    ...
    function sttunjangan() {
        return $this->hasMany('App\Model\Setting\SettingTunjanganKaryawanModel', 'st_grouptunjangankaryawan_id', 'grouptunjangankaryawan_id');
    }
