...
class SettingAnnouncementModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'st_announcement';
    protected $primaryKey = 'announcement_id';
    public $timestamps = false;

    protected static $logName = 'announcement';
    protected static $logUnguarded = true;
    protected $labelTableName = 'st_announcement';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan pengumuman baru dengan ID TU";
        } else {
            return "$defaultCauserName melakukan perubahan data pengumuman dengan ID TU";
        }
