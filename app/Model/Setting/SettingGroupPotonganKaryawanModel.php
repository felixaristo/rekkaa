...
class SettingGroupPotonganKaryawanModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'st_group_potongan_karyawan';
    protected $primaryKey = 'stgrouppotongankaryawan_id';
    public $timestamps = false;

    protected static $logName = 'group_potongan_karyawan';
    protected static $logUnguarded = true;
    protected $labelTableName = 'st_group_potongan_karyawan';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan group potongan karyawan baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data group potongan karyawan dengan ID ";
        }
    ...
    function stpotongan() {
        return $this->hasMany('App\Model\Setting\SettingPotonganKaryawanModel', 'st_grouppotongankaryawan_id', 'grouppotongankaryawan_id');
    }
