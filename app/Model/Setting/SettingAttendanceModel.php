...
class SettingAttendanceModel extends Model
{
    use LogsActivity;
    ...
    protected $labelTableName = 'st_attendance';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan pengaturan absensi baru dengan ID AB";
        } else {
            return "$defaultCauserName melakukan perubahan data pengaturan absensi dengan ID AB";
        }
