...
class AkunBiayaModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'tr_akun_biaya';
    protected $primaryKey = 'akunbiaya_id';
    public $timestamps = false;

    protected static $logName = 'akunbiaya';
    protected static $logUnguarded = true;
    protected $labelTableName = 'tr_akun_biaya';
