...
class UserOrderModel extends Model
{
    ...
    protected $table = 'tr_user_order';
    protected $primaryKey = 'userorder_id';
    public $timestamps = false;

    protected static $logName = 'user_order';
    protected static $logUnguarded = true;
    protected $labelTableName = 'tr_user_order';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan user order baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data user order dengan ID ";
        }
