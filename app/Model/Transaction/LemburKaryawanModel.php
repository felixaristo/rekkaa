...
class LemburKaryawanModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'tr_lembur_karyawan';
    protected $primaryKey = 'lemburkaryawan_id';
    public $timestamps = false;

    protected static $logName = 'lembur_karyawan';
    protected static $logUnguarded = true;
    protected $labelTableName = 'tr_lembur_karyawan';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan lembur karyawan baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data lembur karyawan dengan ID ";
        }
    ...
    {
        return $this->belongsTo(KaryawanModel::class, 'ms_karyawan_id', 'karyawan_id');
    }

    public function manager()
    {
        return $this->belongsTo(KaryawanModel::class, 'lemburkaryawan_manager_id', 'karyawan_id');
    }

    public function admin()
    {
        return $this->belongsTo(User::class, 'lemburkaryawan_approval_adminby', 'user_id');
    }

    public function canceladmin()
    {
        return $this->belongsTo(User::class, 'lemburkaryawan_canceladmin_by', 'user_id');
    }

    // public function approve_by()
    // {
    //     return $this->belongsTo(KaryawanModel::class, 'lemburkaryawan_approval_by', 'karyawan_id');
    // }
}
