...
class AttendanceKaryawanModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'tr_attendance_karyawan';
    protected $primaryKey = 'attendancekaryawan_id';
    public $timestamps = false;
    
    protected static $logName = 'attendance_karyawan';
    protected static $logUnguarded = true;
    protected $labelTableName = 'tr_attendance_karyawan';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan absensi baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data absensi dengan ID ";
        }
