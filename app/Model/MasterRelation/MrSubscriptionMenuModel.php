...
class MrSubscriptionMenuModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'mr_subscription_menu';
    protected $primaryKey = 'subscriptionmenu_id';
    public $timestamps = false;
    
    protected static $logName = 'subscription_menu';
    protected static $logUnguarded = true;
    protected $labelTableName = 'mr_subscription_menu';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan subscription menu baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data subscription menu dengan ID ";
        }
