...
class MrSubscriptionPermissionModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'mr_subscription_permission';
    protected $primaryKey = 'subscriptionpermission_id';
    public $timestamps = false;

    protected static $logName = 'subscription_permission';
    protected static $logUnguarded = true;
    protected $labelTableName = 'mr_subscription_permission';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan subscription permission baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data subscription permission dengan ID ";
        }
