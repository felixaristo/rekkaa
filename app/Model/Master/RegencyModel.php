...
class RegencyModel extends Model
{
    ...
    protected static $logName = 'regencies';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_regencies';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan regency baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data regency dengan ID ";
        }
