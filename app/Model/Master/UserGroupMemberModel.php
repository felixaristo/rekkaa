...
class UserGroupMemberModel extends Model
{
    ...
    protected $table = 'tr_user_group_member';
    protected $primaryKey = 'usergroupmember_id';
    public $timestamps = false;
    
    protected static $logName = 'user_group_member';
    protected static $logUnguarded = true;
    protected $labelTableName = 'tr_user_group_member';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan user group member baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data user group member dengan ID ";
        }
