...
class CountryModel extends Model
{
    ...
    protected $labelTableName = 'ms_countries';
    // public $timestamps = false;
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan country baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data country dengan ID ";
        }
