...
class TaperaRateModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'ms_tapera_rate';
    protected $primaryKey = 'taperarate_id';
    public $timestamps = false;

    protected static $logName = 'tapera_rate';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_tapera_rate';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan rate BPJS baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data rate BPJS dengan ID ";
        }
