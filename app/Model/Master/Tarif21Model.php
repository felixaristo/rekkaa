...
class Tarif21Model extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'ms_tarif21';
    protected $primaryKey = 'tarif21_id';
    public $timestamps = false;
    
    protected static $logName = 'tarif21';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_tarif21';
     ...
     */
    protected $fillable = [
        'tarif21_year', 'tarif21_description', 'tarif21_rate', 'tarif21_startincome', 'tarif21_endincome', 'tarif21_active',
    ];
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan tarif21 baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data tarif21 dengan ID ";
        }
