...
class AdminModel extends Model
{
    ...
    protected $labelTableName = 'ms_admin';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan kadminaryawan baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data admin dengan ID ";
        }
