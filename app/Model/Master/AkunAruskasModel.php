...
class AkunAruskasModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'ms_akun_aruskas';
    protected $primaryKey = 'akunaruskas_id';
    public $timestamps = false;

    protected static $logName = 'akun_aruskas';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_akun_aruskas';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan akun baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data akun dengan ID ";
        }
