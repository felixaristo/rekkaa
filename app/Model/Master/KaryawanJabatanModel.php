...
class KaryawanJabatanModel extends Model
{
    ...
    protected $table = 'ms_karyawan_jabatan';
    protected $primaryKey = 'karyawanjabatan_id';
    public $timestamps = false;

    protected static $logName = 'karyawan_jabatan';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_karyawan_jabatan';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan jabatan karyawan baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data jabatan karyawan dengan ID ";
        }
    ...
    function karyawan() {
        return $this->hasOne('App\Model\Master\KaryawanModel', 'ms_karyawanjabatan_id', 'karyawanjabatan_id')
