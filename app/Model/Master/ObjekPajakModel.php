...
class ObjekPajakModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'ms_objek_pajak';
    protected $primaryKey = 'objekpajak_id';
    public $timestamps = false;

    protected static $logName = 'objek_pajak';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_objek_pajak';
    /**
     ...
     */
    protected $fillable = [
        'objekpajak_id', 'objekpajak_kode', 'objekpajak_uraian', 'objekpajak_tarif', 'objekpajak_jenis',
    ];
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan objek pajak baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data objek pajak dengan ID ";
        }
