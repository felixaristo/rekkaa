...
class BankModel extends Model
{
    ...
    protected $labelTableName = 'ms_bank';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan bank baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data bank dengan ID ";
        }
