...
class KaryawanInfoFieldModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'ms_karyawan_infofield';
    protected $primaryKey = 'karyawaninfofield_id';
    public $timestamps = false;

    protected static $logName = 'karyawaninfofield';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_karyawaninfofield';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan info field karyawan baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data info field karyawan dengan ID ";
        }
