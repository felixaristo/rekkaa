...
class KaryawanKalkulasiModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'ms_karyawan_kalkulasi';
    protected $primaryKey = 'karyawankalkulasi_id';
    public $timestamps = false;

    protected static $logName = 'karyawan_kalkulasi';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_karyawan_kalkulasi';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan kalkulasi karyawan baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data kalkulasi karyawan dengan ID ";
        }
