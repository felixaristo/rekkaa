...
class PtkpDetailModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'ms_ptkp_detail';
    protected $primaryKey = 'ptkpdet_id';
    public $timestamps = false;

    protected static $logName = 'ptkp_detail';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_ptkp_detail';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan tarif17 baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data tarif17 dengan ID ";
        }
