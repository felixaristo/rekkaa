...
class KaryawanDivisiModel extends Model
{
    ...
    protected $table = 'ms_karyawan_divisi';
    protected $primaryKey = 'karyawandivisi_id';
    public $timestamps = false;

    protected static $logName = 'karyawan_divisi';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_karyawan_divisi';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan divisi karyawan baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data divisi karyawan dengan ID ";
        }
    ...
    function karyawan() {
        return $this->hasOne('App\Model\Master\KaryawanModel', 'ms_karyawandivisi_id', 'karyawandivisi_id')
