...
class PtkpModel extends Model
{
    ...
    protected $table = 'ms_ptkp';
    protected $primaryKey = 'ptkp_id';
    public $timestamps = false;

    protected static $logName = 'ptkp';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_ptkp';
     ...
     */
    protected $fillable = [
        'ptkp_marriage_status', 'ptkp_description', 'ptkp_rate', 'ptkp_active',
    ];
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan PTKP baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data PTKP dengan ID ";
        }
