...
class BpjsRateModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'ms_bpjs_rate';
    protected $primaryKey = 'bpjsrate_id';
    public $timestamps = false;

    protected static $logName = 'bpjs_rate';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_bpjs_rate';
