...
class ProvinceModel extends Model
{
    ...
    protected $labelTableName = 'ms_province';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan provinsi baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data provinsi dengan ID ";
        }
