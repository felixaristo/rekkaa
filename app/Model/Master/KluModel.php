...
class KluModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'ms_klu';
    protected $primaryKey = 'klu_id';
    // public $timestamps = false;

    protected static $logName = 'klu';
    protected static $logUnguarded = true;
    protected $labelTableName = 'ms_klu';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan KLU baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data KLU dengan ID ";
        }
