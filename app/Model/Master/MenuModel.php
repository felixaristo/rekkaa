...
class MenuModel extends Model
{
    ...
    protected $labelTableName = 'ms_menu';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan menu baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data menu dengan ID ";
        }
