...
class PermissionModel extends Model
{
    ...
    protected $labelTableName = 'ms_permission';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan permission baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data permission dengan ID ";
        }
