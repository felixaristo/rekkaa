...
class VwUsergroupModel extends Model
{
    use LogsActivity;
    protected static $logOnlyDirty = true;

    protected $table = 'vw_usergroup';
    protected $primaryKey = 'usergroup_id';
    public $timestamps = false;

    protected static $logName = 'user_group';
    protected static $logUnguarded = true;
    protected $labelTableName = 'vw_user_group';
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        if($eventName == 'created') {
            return "$defaultCauserName menambahkan view user group baru dengan ID ";
        } else {
            return "$defaultCauserName melakukan perubahan data view user group dengan ID ";
        }
