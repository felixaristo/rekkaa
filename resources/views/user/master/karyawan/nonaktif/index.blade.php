...
<script>
  $(function() {
    ...
    let tblKaryawan = $("#table-karyawan").DataTable({
      ...
      "ajax": {
        "url": "{{route('user.page.karyawannonaktif.datatable')}}",
        "type": "GET",
        "data": function(data) {
          ...
          "render": function(data, type, row) {
            ...
            return `
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item btn-view rekkaa-page-link" href="{{route('user.page.karyawannonaktif.profile', '')}}/${data}?menu_id=${currentMenuId}"
    ...
    $("#table-karyawan").on("click", ".btn-active", function(e) {
      ...
      Swal.fire({
        ...
        <div class="mt-3 text-left" id="activate-karyawan">
          <div class="row mb-3">
          ...
          <div class="row" id="akhir_tgl_box" style="display:none;">
            <label class="col-sm-5">Tgl. Berakhir Kontrak<span class="text-danger">*</span><span class="float-right">:</span></label>
            <div class="col-sm-7">
        ...
        preConfirm: () => {
          ...
          return fetch(`{{route('user.page.karyawannonaktif.activate', '')}}/${data.karyawan_id}?menu_id=${currentMenuId}`, {
              method: 'POST',
