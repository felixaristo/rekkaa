							...
							<div class="card mb-3">
								...
								<div class="card-body">
									<div class="form-group row mb-3">
										...
										<div class="col-sm-4">
											<input type="text" required value="{{$karyawan->karyawan_nik}}" name="karyawan_nik" id="karyawan_nik" class="form-control" placeholder="Masukkan NIK">
										</div>
									...
									<div class="form-group row mb-3">
										...
										<div class="col-sm-4">
											<input type="text" required value="{{$dt->translatedFormat('d-m-Y')}}" name="karyawan_birthdate" id="karyawan_birthdate" class="form-control" placeholder="Masukkan Tanggal Lahir">
										</div>
									</div>
									<div class="form-group row mb-3">
										<label for="karyawan_phone" class="col-sm-2 lbl-req">No. Telepon</label>
										<div class="col-sm-4">
											<input type="text" required value="{{$karyawan->karyawan_phone}}" name="karyawan_phone" id="karyawan_phone" class="form-control" placeholder="Masukkan No. Telepon">
										</div>
									...
									<div class="form-group row mb-3">
										...
										<div class="col-sm-4">
											<select name="ptkp_id" required id="ptkp_id" style="width: 100%;" data-placeholder="-: Pilih Data :-">
									...
									<div class="form-group row mb-3">
										...
										<div class="col-sm-4">
											<div class="form-check form-check-inline">
												<input name="karyawan_gender" class="form-check-input" {{($karyawan->karyawan_gender == 'L') ? 'checked' : ''}} type="radio" value="L" id="karyawan_gender_l" checked="">
												<label class="form-check-label" for="karyawan_gender_l"> Laki-laki </label>
											</div>
											<div class="form-check form-check-inline">
												<input name="karyawan_gender" class="form-check-input" {{($karyawan->karyawan_gender == 'P') ? 'checked' : ''}} type="radio" value="P" id="karyawan_gender_p">
									...
									<div class="form-group row mb-3">
										...
										<div class="col-sm-4">
											<textarea name="karyawan_address" required id="karyawan_address" class="form-control" placeholder="Masukkan Alamat">{{$karyawan->karyawan_address}}</textarea>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card-body">
									<div class="form-group row mb-3">
										...
										<div class="col-sm-4">
											...
											<span class="help-block mt-1"><sup class="text-danger">*</sup>Status tidak bisa diedit.</span>
										</div>
										<label for="karyawan_taxtype" class="col-sm-2 lbl-req">Jenis Pajak</label>
										<div class="col-sm-4">
											<select name="karyawan_taxtype" {{($karyawan->karyawanmasakerja_status == 'NONKARYAWAN') ? '' : 'disabled'}} id="karyawan_taxtype" style="width: 100%;" data-placeholder="-: Pilih Data :-">
									...
									<div class="form-group row mb-3">
										...
										<div class="col-sm-4">
											<div class="row">
												<div class="col-sm-12 mb-2">
													...
													<span class="help-block mt-1"><sup class="text-danger">*</sup>Tgl. Berlaku tidak bisa diedit.</span>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-4">
											<div class="form-check form-check-inline">
												<input name="karyawan_calculation_method" {{($karyawan->karyawanmasakerja_status == 'NONKARYAWAN') ? 'disabled' : ''}} {{($karyawan->karyawanmasakerja_calculation_method == 'GROSS') ? 'checked' : ''}} class="form-check-input" type="radio" value="GROSS" id="karyawan_calculation_method_g">
												<label class="form-check-label" for="karyawan_calculation_method_g">Gross</label>
											</div>
											<div class="form-check form-check-inline">
												<input name="karyawan_calculation_method" {{($karyawan->karyawanmasakerja_status == 'NONKARYAWAN') ? 'disabled' : ''}} {{($karyawan->karyawanmasakerja_calculation_method == 'GROSS_UP') ? 'checked' : ''}} class="form-check-input" type="radio" value="GROSS_UP" id="karyawan_calculation_method_gu">
									...
									<div class="form-group row mb-3">
										...
										<div class="col-sm-4">
											<input type="text" required value="{{$karyawan->karyawanmasakerja_salary}}" name="karyawan_salary" id="karyawan_salary" class="form-control" placeholder="Masukkan Gaji Pokok">
										</div>
										<label for="karyawan_position" class="col-sm-2 lbl-req">Jabatan</label>
										<div class="col-sm-4">
											<input type="text" required value="{{$karyawan->karyawanmasakerja_position}}" name="karyawan_position" id="karyawan_position" class="form-control" placeholder="Masukkan Jabatan">
										</div>
									</div>
								</div>
							</div>
							<div id="card-bpjs" class="card mb-3">
								...
								<div class="card-body">
									<div class="form-group row mb-3">
										...
										<div class="col-sm-4">
											<div class="form-check form-check-inline">
												<input name="karyawan_bpjs[]" {{($bpjs_tk) ? 'checked' : ''}} class="form-check-input karyawan_bpjs" type="checkbox" data-type="TENAGA_KERJA" value="TENAGA_KERJA" id="karyawan_bpjs_tk">
												<label class="form-check-label" for="karyawan_bpjs_tk">Tenaga Kerja</label>
											</div>
											<div class="form-check form-check-inline">
												<input name="karyawan_bpjs[]" {{($bpjs_kes) ? 'checked' : ''}} class="form-check-input karyawan_bpjs" type="checkbox" data-type="KESEHATAN" value="KESEHATAN" id="karyawan_bpjs_kes">
											...
											foreach($stbpjskaryawan_data as $stbpjskaryawan) {
												if($stbpjskaryawan->stbpjskaryawan_type == 'TENAGA_KERJA') {
													...
													$bpjs_tk_html .= '<div class="form-group mb-3">
														<div class="form-check form-check-inline">
															<input '.$stbpjs_checked.' name="bpjs_tk['.$stbpjskaryawan->stbpjskaryawan_name.']" class="form-check-input bpjstk-input '.$className.'" type="checkbox" value="'.$nominal_bpjs_val.'" id="TK_'.$stbpjskaryawan->stbpjskaryawan_name.'">
													...
													if($stbpjskaryawan->stbpjskaryawan_name == 'LAINNYA') {
														...
														$bpjs_tk_html .= '<div class="row mb-3 bpjs-tk-lainnya-box" '.$cssdisplay.'>
															...
															<div class="col-sm-5">
															<input type="text" '.$cssdisabled.' required name="bpjs_tk_tunjangan_lainnya" id="bpjs_tk_tunjangan_lainnya" value="'.$lainnyanominal_bpjs.'" class="form-control" placeholder="Masukkan Tunjangan Lainnya">
															</div>
														</div>';
													}
												}
												...
												if($stbpjskaryawan->stbpjskaryawan_type == 'KESEHATAN') {
													...
													$bpjs_kes_html .= '<div class="form-group mb-3">
														<div class="form-check form-check-inline">
															<input '.$stbpjs_checked.' name="bpjs_kes['.$stbpjskaryawan->stbpjskaryawan_name.']" class="form-check-input bpjskes-input '.$className.'" type="checkbox" value="'.$nominal_bpjs_val.'" id="KES_'.$stbpjskaryawan->stbpjskaryawan_name.'">
													...
													if($stbpjskaryawan->stbpjskaryawan_name == 'LAINNYA') {
														...
														$bpjs_kes_html .= '<div class="row mb-3 bpjs-kes-lainnya-box" '.$cssdisplay.'>
															...
															<div class="col-sm-5">
															<input type="text" '.$cssdisabled.' required name="bpjs_kes_tunjangan_lainnya" id="bpjs_kes_tunjangan_lainnya" value="'.$lainnyanominal_bpjs.'" class="form-control" placeholder="Masukkan Tunjangan Lainnya">
															</div>
														</div>';
													}
												}
							...
							<div id="card-tunjangan" class="card mb-3">
								...
								?>
									<div class="row mb-3">
										...
										<div class="col-sm-6">
											<input type="text" value="{{$tunjanganpegawai_value}}" name="karyawan_tunjangan[{{$sttunjangankaryawan->sttunjangankaryawan_code}}]" id="karyawan_tunjangan_{{$sttunjangankaryawan->sttunjangankaryawan_code}}" class="form-control input_tunjangan" placeholder="Masukkan {{$sttunjangankaryawan->sttunjangankaryawan_name}}">
										</div>
									</div>
								<?php 
									endforeach;
...
<script>
	$(function() {
		...
		$("#bpjs_kes_tunjangan_lainnya").change(function() {
			console.log('LLL', bpjsKesTunjanganLainnya.getNumber());
			$("#KES_LAINNYA").val(bpjsKesTunjanganLainnya.getNumber());
		})
		$("#bpjs_tk_tunjangan_lainnya").change(function() {
			console.log('LLL', bpjsTkTunjanganLainnya.getNumber());
