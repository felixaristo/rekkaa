...
<div class="row">
  <div class="col-lg-12 mb-4 order-0">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{route('user.page.karyawan-import-tunjangan.import')}}" method="POST" class="form-horizontal form-lbl-dot" id="formKaryawanImportTunjangan" autocomplete="off" enctype="multipart/form-data">
          <div class="form-group row mb-3">
            ...
            <div class="col-sm-4">
              ...
              <span class="help-block"><a href="{{route('user.page.karyawan-import-tunjangan.downloadtemplate')}}" target="_blank">Download Template</a></span>
            </div>
          </div>
          <div class="form-group row mb-3">
...
$(function() {
    ...
    let formKaryawanImportTunjangan = $("#formKaryawanImportTunjangan").validate({
