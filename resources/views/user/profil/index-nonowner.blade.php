        ...
        <div class="col-sm-12">
          <div class="card-body">
            <div class="nav-align-top mb-4">
              <form id="formEntitas" method="POST" action="{{route('user.page.profil.update')}}" class="row needs-validation form-lbl-dot" novalidate autocomplete="off">
                <div class="col-sm-12">
                  <div class="row mb-3">
                    <label class="col-sm-12 nodot-label lbl-req" for="profil_name">Nama</label>
                    <div class="col-sm-12">
                  ...
                  <div class="row mb-3">
                    <label class="col-sm-12 nodot-label" for="profil_email">Email</label>
                    <div class="col-sm-12">
                      <input type="text" disabled value="{{$user->user_email}}" name="profil_email" id="profil_email" class="form-control" placeholder="Masukkan Email">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label class="col-sm-12 nodot-label lbl-req" for="profil_hp">No. Telepon</label>
                    <div class="col-sm-12">
                      <input type="text" required value="{{$user->userwajibpajak->userwajibpajak_phone}}" name="profil_hp" id="profil_hp" class="form-control" placeholder="Masukkan No. Telepon">
                    </div>
                  </div>
                </div>
