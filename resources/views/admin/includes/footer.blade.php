        ...
        <script>
            ...
            $.extend($.fn.DataTable.defaults, {
                "scrollX": true,
                "language" : {
                    "emptyTable": "<img class='mt-2' src='{{asset('assets/img/illustrations/data-rekkaa.png')}}' style='max-width:20%; opacity: 0.6'><h4 class='mt-2'>No data available in table</h4>",
                }
            });
