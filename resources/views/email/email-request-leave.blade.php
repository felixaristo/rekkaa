                ...
                >
                    ...
                    >
                        <span style="color: #566a7f"
                            ...
                            <br>
                            <br>Hari ini {{$content->staff_name}} melakukan Pengajuan Cuti untuk alasan {{$content->reason}} pada tanggal {{$content->start_date}} selama {{$content->quota_use}} hari.
                            <br>
                            <br>Untuk detail pengajuan cuti, dapat di cek dalam fitur Daftar Cuti.
                            <br>
                            <br>Terima Kasih.
                            </span></span>
                    </p>
