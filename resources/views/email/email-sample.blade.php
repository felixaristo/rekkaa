                    ...
                    >
                        <span style="color: #566a7f"
                            ><span style="font-size: 16px">
                                Halo <b>Gani</b>,
                                <br>
                                <br />Akun Anda telah berhasil dibuat, silahkan klik tautan 
                                <br>
                                <br>
                                <a href="{{url('/verifikasi?token=#')}}" class="btn-link"
                                ...
                                <br>
                                <br>
                                untuk melakukan verifikasi akun. Jika anda tidak melakukan permintaan ini, abaikan email ini.
                            </span></span
                        >
                    </p>
                </div>
