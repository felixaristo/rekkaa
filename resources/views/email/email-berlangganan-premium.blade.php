                ...
                >
                    ...
                    >
                        ...
                        <span style="color: #566a7f"
                            ...
                            <br>
                            <br>Terima kasih telah mendaftar di REKKAA, kini <b>{{$subscription->wajibpajak_name}}</b> berlangganan paket <b>{{$subscription->title}}</b> sampai dengan tanggal <b>{{ $parse_expired_at->format('d-m-Y') }}</b>.
                            <br>
                            <br>
