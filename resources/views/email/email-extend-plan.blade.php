                ...
                >
                    ...
                    >
                        <span style="color: #566a7f"
                            ...
                            <br>
                            <br>Selamat, masa berlangganan paket <b>{{$subscription->title}}</b> untuk <b>{{$subscription->wajibpajak_name}}</b> berhasil diperpanjang sampai dengan tanggal <b>{{$parse_expired_at->format('d-m-Y')}}</b>.
                            </span></span>
                    </p>
                </div>
            </div>
