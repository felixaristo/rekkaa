					...
					<p
						...
						<span style="color:#566a7f;">
							<span
								...
								{{$entity->user_name}},
								<br>Anda telah diundang oleh {{$entity->inviter_email}} sebagai karyawan di {{$entity->name}}.
								@if(isset($entity->total_entity) && $entity->total_entity > 0)
								<br>
								<br>Silahkan login menggunakan akun anda sebelumnya untuk menggunakan aplikasi REKKAA.
								<br>
								<br>
								<a
								...
								@else
								<br>
								<br>Silahkan klik tautan di bawah untuk mengatur kata sandi Anda untuk menggunakan aplikasi REKKAA.
								<br>
								<br>Selamat bergabung!
								<br>
								<br>
								<a
									href="{{url('/karyawan/reset-password?token='.$entity->forgot_token.'&reset=0')}}"
									class="btn-link"
									style="border: 1px solid #ddd;
									padding: 10px 25px;
									background-color: #ff8139;
									...
									display: table;
									margin: auto;
									text-align: center;">Atur Kata Sandi</a>
								<br>
								@endif
                                <br>
