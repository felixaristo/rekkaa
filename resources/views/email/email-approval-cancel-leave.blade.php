                ...
                >
                    ...
                    >
                        <span style="color: #566a7f"
                            ...
                            <br>
                            <br>Terkait pembatalan cuti yang diajukan untuk tanggal {{$content->start_date}} selama {{$content->quota_use}} hari, telah {{$content->status}} oleh {{$content->manager_name}}.
                            <br>
                            <br>Untuk detail terkait cuti ini, dapat di cek pada fitur Pengajuan Cuti.
                            <br>
                            <br>Terima Kasih.
                            </span></span>
                    </p>
