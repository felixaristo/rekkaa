                    ...
                    >
                        <span style="color: #566a7f"
                            ><span style="font-size: 16px">
                                Halo <b>{{ $wajibpajak->wajibpajak_name }}</b>,
                                <br>
                                <br />Akun Anda telah berhasil dibuat, silahkan klik tautan di bawah ini untuk melakukan verifikasi akun.
                                <br>
                                <br>
                                <a href="{{url('/verifikasi?token='.$user->user_verified_token)}}" class="btn-link"
                                style="border: 1px solid #ddd;
									...
									display: table;
									margin: auto;
									text-align: center;">Verifikasi Akun</a>
                                <br>
                                <br>
