                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-md-3">
                      ...
                      <select id="status" name="status" class="form-control">
                          ...
                          <option value="APPROVEDMANAGER">Disetujui Manager</option>
  ...
  <div class="col-lg-12 mb-4 order-0">
    <div class="card">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card-body">
            <table class="table table-hover display nowrap" style="width: 100%" id="table-lembur">
              <thead>
                <tr>
                    <th>Nama Karyawan</th>
                    ...
                    <th>Tanggal Persetujuan Admin</th>
                    <th>Aksi</th>
                </tr>
              </thead>
            </table>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          ...
          <!-- <div class="form-group disetujui-oleh-field" style="display: none;">
            <label for="disetujui-oleh"><em>Disetujui Oleh Admin</em></label>
            <p id="disetujui-olehadmin" class="font-weight-bold"></p>
          </div> -->
...
<script>
  ...
  $("#karyawan_ids").select2({
      ...
      ajax: {
        url: `{{route('karyawan.lembur.karyawan.select')}}`,
  ...
  let tblLembur = $("#table-lembur").DataTable({
  ...
  //   "paging": true, // Enable pagination
    ...
    "ordering": false,
    "ajax": {
      "url": "{{ route('karyawan.lembur.list.manager') }}", // Replace with your actual route to fetch data
      "type": "GET",
      "data": function(data) {
    ...
    "columns": [
      ...
      },
      {
        ...
        "render": function(data, type, row) {
          if(data === 'APPROVED') {
            return '<span class="badge bg-success">Disetujui Admin</span>'
      ...
      {
        "data": "lemburkaryawan_approval_date",
      ...
      },
      {
        ...
        "title": "Tanggal Persetujuan Admin",
        "className": "text-center",
        "render": function(data, type, row) {
          return (data) ? moment(data).format('DD-MM-YYYY HH:mm:ss') : '-';
        }
      },
      {
        ...
        "render": function(data, type, row) {
          ...
          if(row.lemburkaryawan_status === 'WAITING' || row.lemburkaryawan_status === 'WAITINGCANCEL') {
            btn +=`<a class="dropdown-item btn-edit" href="javascript:void(0);"
                  ><i class="bx bx-edit-alt me-1 text-info"></i> Edit</a>
  ...
  $("#table-lembur").on("click", ".detail-button", function() {
    ...
    if (rowData.lemburkaryawan_status === "APPROVED") {
        ...
        if(rowData.admin) {
          ...
          $("#detailModal #disetujui-oleh").text();
        }
    } else {
  ...
  $("#table-lembur").on("click", ".btn-reject", function(e) {
    e.preventDefault();
    ...
    Swal.fire({
      html: 'Apakah anda ingin menolak pengajuan lembur ini?',
      icon: 'question',
      ...
      preConfirm: async () => {
          ...
          if (swalResult.isConfirmed) {
              ...
              return fetch("{{ route('karyawan.lembur.pengajuan.rejectmanager', '') }}/"+lemburId, {
                  method: 'POST',
  ...
  $("#table-lembur").on("click", ".btn-approve", function(e) {
    e.preventDefault();
    ...
    Swal.fire({
      ...
      preConfirm: async () => {
          ...
          if (swalResult.isConfirmed) {
              ...
              return fetch("{{ route('karyawan.lembur.pengajuan.approvemanager', '') }}/"+lemburId, {
                  method: 'POST',
                  body: new URLSearchParams($.param(requestData)),
              })
              .then(response => {
  ...
  $("#btnPengajuan").click(function() {
    ...
    $("#formPengajuan").attr("action", "{{route('karyawan.lembur.pengajuan.createmanager')}}");
  ...
  let formPengajuan = $("#formPengajuan").validate({
    ...
    $("#table-lembur").on("click", ".btn-edit", function(e) {
        e.preventDefault();
        $("#formPengajuan")[0].reset(); // Reset the form fields
        ...
        $("#formPengajuan").attr("action", "{{route('karyawan.lembur.pengajuan.updatemanager', '')}}/"+rowData.lemburkaryawan_id);
        $("#pengajuanModal").modal("show");
    });

    $("#table-lembur").on("click", ".btn-delete", function(e) {
    e.preventDefault();
    ...
    Swal.fire({
      ...
      preConfirm: async () => {
          ...
          if (swalResult.isConfirmed) {
              ...
              return fetch("{{ route('karyawan.lembur.pengajuan.cancelmanager', '') }}/"+lemburId, {
                  method: 'POST',
                  body: new URLSearchParams($.param(requestData)),
              })
              .then(response => {
