...
<div class="modal fade" id="pengajuanModal" tabindex="-1" aria-labelledby="pengajuanModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form id="formPengajuan" action="{{route('karyawan.lembur.pengajuan.create')}}" method="POST" class="needs-validation form-lbl-dot" novalidate autocomplete="off">
...
<script>
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
          ...
          success: function(response) {
              ...
              $("#formPengajuan").attr("action", "{{route('karyawan.lembur.pengajuan.create')}}");
          }
      })
    },
  })
  ...
  $("#table-lembur").on("click", ".btn-edit", function(e) {
      ...
      $("#formPengajuan").attr("action", "{{route('karyawan.lembur.pengajuan.update', '')}}/"+rowData.lemburkaryawan_id);
    ...
    Swal.fire({
      ...
      preConfirm: async () => {
          ...
          if (swalResult.isConfirmed) {
              ...
              return fetch("{{ route('karyawan.lembur.pengajuan.cancel', '') }}/"+lemburId, {
                  method: 'POST',
  ...
  //   "paging": true, // Enable pagination
    ...
    "ordering": false,
    "ajax": {
      "url": "{{ route('karyawan.lembur.list.karyawan') }}", // Replace with your actual route to fetch data
      "type": "GET",
      "data": function(data) {
    ...
    "columns": [
      ...
      },
      {
        ...
        "render": function(data, type, row) {
          let btn = '';
          if(row.lemburkaryawan_status === 'WAITING') {
            ...
            btn += `<a class="dropdown-item detail-button" href="javascript:void(0);">
  ...
  $("#table-lembur").on("click", ".detail-button", function() {
    ...
    // $("#detailModal #keputusan-penerimaan").text(rowData.lemburkaryawan_approval_date ? rowData.lemburkaryawan_approval_date : "-");
