                    ...
                    LinkDialog_createClass(LinkDialog, [
                        {
                            ...
                            value: function initialize() {
                                ...
                                var buttonClass =
                                    "btn btn-secondary note-btn note-btn-primary note-link-btn";
                                var footer =
                    ...
                    ImageDialog_createClass(ImageDialog, [
                        {
                            ...
                            value: function initialize() {
                                ...
                                var buttonClass =
                                    "btn btn-secondary note-btn note-btn-primary note-image-btn";
                                var footer =
                                    '<input type="button" href="#" class="'
                                        .concat(buttonClass, '" value="')
                                        .concat(
                    ...
                    VideoDialog_createClass(VideoDialog, [
                        {
                            ...
                            value: function initialize() {
                                ...
                                var buttonClass =
                                    "btn btn-secondary note-btn note-btn-primary note-video-btn";
                                var footer =
                                    '<input type="button" href="#" class="'
                                        .concat(buttonClass, '" value="')
                                        .concat(
