...
bt.grid.plugins.grouping = {
    config: {
        ...
        glyphicons: {
            icons: {
                expandGroup: '<span class="bx bx-plus" />',
                collapseGroup: '<span class="bx bx-minus" />'
            }
        }
    },
...
bt.tree.config = {
    ...
    glyphicons: {
        ...
        icons: {
            expand: '<span class="bx bx-plus" />',
            collapse: '<span class="bx bx-minus" />'
        }
    }
};
/**
